...
const LoginModal = ({className,value,valueChangedHandler,onSubmit}) => {
    ...
    <div className={className}> 
      <>
        <button
          className="colorAccent centerHorizontal textColorPrimary font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
          type="button"
